...
Date: 2026-08-31
Superseded: 2026-09-03 — ADR 0025's derived bucket pattern gave every factory bucket a
fixed prefix, which let the KB's read permission be written once with a wildcard and
made this ADR's recommendation the more expensive of two equals.

> **This text is the record of what was decided on 2026-08-31 and is preserved
> unaltered. Do not act on it.** It recommends option (d), a bucket policy per new
> bucket. The current answer is option (b), in
> [ADR-0034](0034-kb-read-access-shared-role-prefix.md).
>
> A revision note was prepended to this file in place on 2026-09-01; it has been
> removed and the original restored from commit `8cc3365`, because the supersession
> rule now forbids editing an ADR to say something else.
